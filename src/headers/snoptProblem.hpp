...
class snoptProblemA : public snoptProblem {
 ...
 public:
  ...
  void setX(double *x, double *xlow, double *xupp, double *xmul, int *xstate);
  void setF(double *F, double *Flow, double *Fupp, double *Fmul, int *Fstate);
...
class snoptProblemC : public snoptProblem {
 ...
 public:
  ...
  void setX(double *bl, double *bu, double *x, double *pi, double *rc, int *hs);
